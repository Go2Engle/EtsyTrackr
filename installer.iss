...
[Files]
Source: "dist\dir\EtsyTrackr\EtsyTrackr.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\dir\EtsyTrackr\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
